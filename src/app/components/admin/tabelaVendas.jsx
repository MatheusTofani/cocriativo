...
import EditarVendaModal from "../vendas/editModal";
import RemoverVendaModal from "../vendas/removerVenda";
...
export default function TabelaVendas() {
  ...
  return (
    <div className="mt-8 space-y-6">
      <div className="bg-[#61482a] py-4">
       <h2 className="text-[#f5efec] font-bold mb-5 text-[20px] px-8">Filtros</h2>
